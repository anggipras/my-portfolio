...
new TypeIt("#type1", {
  ...
  .type("Frontend Engineer", { delay: 400 })
  .pause(500)
  .delete(18)
...
//Social Media
function fbsocmed() {
  window.location.href = 'https://www.facebook.com/anggipras30/'
}

function igsocmed() {
  window.location.href = 'https://www.instagram.com/anggipras30/'
}

function lisocmed() {
  window.location.href = 'https://www.linkedin.com/in/bernardus-anggi-prastianto-8357a111a/'
}